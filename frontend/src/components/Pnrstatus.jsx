...
import LabelNavbar from "../labels/LabelNavbar"; // ✅ added
...
export default function PNRStatus() {
  ...
  return (
    <>
      ...
      <div id="pnr-section" className="max-w-6xl mx-auto mt-20 px-6 pb-14 flex justify-center flex-col text-white">
        {/* 1. CREATIVE HEADER */}
