    ...
    return (
      ...
      `}>
                ...
                <div className="flex items-center gap-3 px-5 py-5 border-b border-white/5">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#4ab86d] to-blue-500 flex items-center justify-center text-white font-black text-base shadow-lg">S</div>
                    <div>
            ...
            <div className="flex-1 flex flex-col min-w-0 min-h-screen">
                ...
                <header className="sticky top-0 z-20 flex items-center gap-3 px-4 py-3 bg-[#0d1526] border-b border-white/5 md:hidden">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#4ab86d] to-blue-500 flex items-center justify-center text-white font-black text-xs">S</div>
